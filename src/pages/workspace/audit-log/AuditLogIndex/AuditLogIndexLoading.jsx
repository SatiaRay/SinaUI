          ...
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="flex flex-col gap-1">
              <SkeletonLoading
                height={10}
                width={70 + i * 15}
                containerClassName="ml-auto !mb-0 !mt-0"
                className="rounded-md"
              />
          ...
          {[60, 60, 80].map((w, i) => (
            <div key={i} className={`flex flex-col ${i === 2 ? 'flex-1' : ''}`}>
              <SkeletonLoading
                height={10}
                width={w}
                containerClassName="ml-auto !mb-1"
                className="rounded-md"
              />
              <SkeletonLoading
                height={36}
      ...
      <div className="hidden xl:block mt-5 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
        <div className="p-4">
          ...
          {Array.from({ length: 7 }).map((_, i) => (
            <div
              key={i}
              className="grid grid-cols-6 gap-0 items-center py-0 border-b border-gray-100 dark:border-gray-700 last:border-0"
            >
