/**
 * Modern Monitoring Error Component
...
const MonitoringError = ({ error, onRetry }) => {
  ...
  const getErrorMessage = () => {
    ...
    if (error?.status) {
      switch (error.status) {
        case 404:
          return 'لاگ های درخواستی یافت نشد. لطفاً اتصال خود را بررسی کرده و دوباره تلاش کنید.';
        case 403:
          return 'دسترسی محدود شده است. شما مجوز مشاهده این لاگ ها را ندارید.';
        case 500:
        ...
        default:
          return `خطای ${error.status} در هنگام بارگذاری لاگ ها رخ داده است`;
      }
    }

    return 'بارگذاری لاگ ها ناموفق بود. لطفاً اتصال خود را بررسی کرده و دوباره تلاش کنید.';
  };
