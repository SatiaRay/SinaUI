...
const UpdateDataSource = (props) => {
    ...
    const fetchDocument = async () => {
        ...
        setError(null);
        try {
            const response = await fetch(`${process.env.REACT_APP_CHAT_API_URL}/document/vector/${document_id}`);
            if (!response.ok) {
    ...
    const handleUpdate = async () => {
        ...
        setError(null);
        try {
            const response = await fetch(`${process.env.REACT_APP_CHAT_API_URL}/document/${documentData.id}?update_vector=true`, {
                method: 'PUT',
                headers: {
