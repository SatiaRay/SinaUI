/**
 * Modern Workflow Error Component - Responsive Version
...
const Error = ({
  ...
  const getErrorMessage = () => {
    ...
    if (error?.status) {
      switch (error.status) {
        case 404:
          return 'داده های  درخواستی یافت نشد. لطفاً اتصال خود را بررسی کرده و دوباره تلاش کنید.';
        case 403:
          return 'دسترسی محدود شده است. شما مجوز مشاهده این داده ها را ندارید.';
        case 500:
        ...
        default:
          return `خطای ${error.status} در هنگام بارگذاری داده ها رخ داده است`;
      }
    }

    return 'بارگذاری داده ها ناموفق بود. لطفاً اتصال خود را بررسی کرده و دوباره تلاش کنید.';
  };
      ...
      >
        ...
        <div className="relative flex flex-col items-center text-center gap-8">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-8">
            {/* Left Illustration - Hidden on mobile if disabled */}
            {showIllustrations && !isMobile && (
            ...
            {/* Right Illustration - Hidden on mobile if disabled */}
            {showIllustrations && !isMobile && (
...
Error.propTypes = {
  ...
  message: PropTypes.string,
  showIllustrations: PropTypes.bool,
