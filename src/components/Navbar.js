        ...
        <>
            ...
            <div className="md:hidden fixed top-4 right-4 z-50">
                <button
                    ...
                    className="text-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 p-2 rounded-md"
                >
                    {sidebarOpen ? (
            ...
            {/* Sidebar - Desktop */}
            <div className="hidden md:block fixed right-0 top-0 bottom-0 w-64 bg-gray-800 dark:bg-gray-900 shadow-lg z-10">
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-4 border-t border-gray-700">
                        ...
                        <button
                            ...
                            className="w-full text-gray-300 hover:bg-gray-700 hover:text-white px-4 py-2 rounded-md text-sm font-medium"
                        >
                            خروج
                        </button>
                    </div>
            ...
            {sidebarOpen && (
                <div className="md:hidden fixed inset-0 z-50">
                    ...
                    <div className="fixed right-0 top-0 bottom-0 w-64 bg-gray-800 dark:bg-gray-900 shadow-lg">
                        <div className="flex flex-col h-full">
